!(function (e, t) {
    ...
    return (function (e) {
                    ...
                    dynamicLoadSource: function (e, t) {
                        if ((0, s.default)('script[src="' + e + '"]').length) t && t();
                            ...
                            (n.onload = n.onreadystatechange =
                                ...
                                (0, s.default)("head")[0].appendChild(n),
                                (n.src = e);
                        }
                    },
        ...
        function (e, t, n) {
            ...
            var i = n(16),
                o = n(50);
            for (var a in ((t = e.exports = r), (t.FilterCSS = o), i)) t[a] = i[a];
            ...
            var o = function (e, t, n, r) {
                ...
                return "a" === e && "class" == t && "at" === n
                    ...
                    : "img" === e && /src|class/i.test(t)
                        ? t + "='" + i.default.escapeAttrValue(n) + "' referrerPolicy='no-referrer'"
                        : void 0;
            };
        },
        function (e, t, n) {
        ...
        function (e, t, n) {
            ...
            var a = n(42),
                ...
                F = r(E),
                C = n(35),
                _ = (r(C), { comment: "", nick: "", mail: "", link: "", ua: w.default.ua, url: "", QQAvatar: "" }),
                S = "",
                O = {},
                B = {
            ...
            (i.prototype.init = function (e) {
                ...
                return (
                    e &&
                    ((e = w.default.extend(d.CONFIG, e)),
                        (t.i18n = (0, c.default)(e.lang || w.default.lang, e.langMode)),
                        (t.cfg = e),
                        (p.default.maps = (!!e.emojiMaps && e.emojiMaps) || p.default.maps),
                        (p.default.cdn = (!!e.emojiCDN && e.emojiCDN) || p.default.cdn),
                        t._init()),
                    t
                );
            }),
                (i.prototype._init = function () {
                    ...
                    try {
                        ...
                        var c = B.ds,
                            f = r ? "&q=" + (0, d.RandomStr)() : "";
                        (B.params = "?d=" + (c.indexOf(n) > -1 ? n : "mp") + "&v=" + d.VERSION + f),
                            (B.hide = "hide" === n),
                            (B.cdn = /^https?\:\/\//.test(i) ? i : B.cdn),
                            (e.cfg.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s),
                            l &&
                            (0, y.recordIPFn)(function (e) {
                                return (_.ip = e);
                            });
                        var p = e.cfg.el || null,
                            h = (0, w.default)(p);
                        if ((p = p instanceof HTMLElement ? p : h[h.length - 1] || null)) {
                            (e.$el = (0, w.default)(p)),
                                e.$el.addClass("v").attr("data-class", "v"),
                                B.hide && e.$el.addClass("hide-avatar"),
                                (e.cfg.meta = (e.cfg.guest_info || e.cfg.meta || d.defaultMeta).filter(function (e) {
                                    return d.defaultMeta.indexOf(e) > -1;
                                })),
                                (e.cfg.requiredFields = e.cfg.requiredFields.filter(function (e) {
                                    return d.defaultMeta.indexOf(e) > -1;
                                }));
                            var v = (0 == e.cfg.meta.length ? d.defaultMeta : e.cfg.meta).map(function (t) {
                                var n = "mail" == t ? "email" : "text";
                                return d.defaultMeta.indexOf(t) > -1
                                    ? '<input name="' + t + '" placeholder="' + e.i18n.t(t) + '" class="v' + t + ' vinput" type="' + n + '">'
                                    : "";
                            }),
                                g =
                            ...
                            var b = e.$el.find(".vempty");
                            e.$nodata = {
                                show: function (t) {
                                    return b.html(t || e.i18n.t("sofa")).show(), e;
                                },
                                hide: function () {
                                    return b.hide(), e;
                                },
                            };
                            var x = e.$el.find(".vload-bottom"),
                                A = e.$el.find(".vload-top");
                            e.$loading = {
                                show: function (t) {
                                    return (t && A.show()) || x.show(), e.$nodata.hide(), e;
                                },
                                hide: function () {
                                    return A.hide(), x.hide(), 0 === e.$el.find(".vcard").length && e.$nodata.show(), e;
                                },
                            };
                        }
                        (0, m.default)(e.cfg, function (t) {
                            var n = (0, w.default)(".valine-comment-count"),
                                r = 0;
                            !(function t(n) {
                                var i = n[r++];
                                if (i) {
                                    var o = (0, w.default)(i).attr("data-xid");
                                    o &&
                                        e
                                            .Q(o)
                                            .count()
                                ...
                                o && j.add(AV.Object.extend("Counter"), e.cfg.path),
                                e.$el && e.bind();
                        });
                    } catch (t) {
            ...
            var $ = function (e, t) {
                ...
                j = {
                    add: function (e, t) {
                        var n = this,
                            r = (0, w.default)(".leancloud_visitors,.leancloud-visitors");
                        if (1 === r.length) {
                            var i = r[0],
                                o = decodeURI((0, w.default)(i).attr("id")),
                                a = (0, w.default)(i).attr("data-flag-title"),
                                u = encodeURI(o),
                                            ...
                                            if (t.length > 0) {
                                                ...
                                                n.increment("time"),
                                                    n
                                                        .save()
                                                        .then(function (e) {
                                                            (0, w.default)(i).find(".leancloud-visitors-count").text(e.get("time"));
                                                        })
                                                        .catch(function (e) { });
                                            } else $(e, s);
                                        })
                                        .catch(function (t) {
                                            101 == t.code ? $(e, s) : (0, D.default)(n, t);
                                        });
                            } else j.show(e, r);
                        } else j.show(e, r);
                    },
                    show: function (e, t) {
                        ...
                        if (
                            (t.forEach(function (e) {
                                ...
                                t && t.text("0"),
                                    n.push(
                                        /\%/.test((0, w.default)(e).attr("id"))
                                            ? decodeURI((0, w.default)(e).attr("id"))
                                            : (0, w.default)(e).attr("id")
                                    );
                            }),
                                n.length)
                        ) {
            ...
            (i.prototype.Q = function (e) {
                ...
                if (1 == n) {
                    ...
                    return (
                        "*" === e ? a.exists("url") : a.equalTo("url", decodeURI(e)), a.addDescending("createdAt"), a.addDescending("insertedAt"), a
                    );
                }
                ...
                (i.prototype.bind = function () {
                    var e = this,
                        ...
                        l = function (e) {
                            var n = [];
                            for (var r in a)
                                a.hasOwnProperty(r) && p.default.build(r) && n.push('<i title="' + r + '" >' + p.default.build(r) + "</i>");
                            t.html(n.join("")),
                                (u = !0),
                                t.find("i").on("click", function (e) {
                                    e.preventDefault(), x(o[0], " :" + (0, w.default)(this).attr("title") + ":");
                                });
                        };
                    (e.$emoji = {
                        show: function () {
                            return !u && l(), e.$preview.hide(), t.show(), r.addClass("actived"), e.$emoji;
                        },
                        hide: function () {
                        ...
                        (e.$preview = {
                            show: function () {
                                return (
                                    S ? (e.$emoji.hide(), i.addClass("actived"), n.html((0, k.default)(S)).show(), z()) : e.$preview.hide(),
                                    e.$preview
                                );
                            },
                            hide: function () {
                    ...
                    var c = function (t) {
                        var r = t.val() || "";
                        r || e.$preview.hide(), S != r && ((S = r), i.hasClass("actived") > -1 && S != n.html() && n.html((0, k.default)(S)), z());
                    };
                    ...
                    var f = e.cfg.meta,
                        h = {},
                        g = { veditor: "comment" };
                    for (var m in (f.forEach(function (e) {
                        g["v" + e] = e;
                    }),
                        g))
                        g.hasOwnProperty(m) &&
                                ...
                                (h[t] = n),
                                    n.on("input change blur propertychange", function (r) {
                                        e.cfg.enableQQ &&
                                            ...
                                            "nick" === t &&
                                            (n.val() && !isNaN(n.val())
                                                ? (0, y.fetchQQFn)(n.val(), function (e) {
                                                    var t = e.nick || n.val(),
                                                        r = e.qq + "@qq.com";
                                                    (0, w.default)(".vnick").val(t),
                                                        (0, w.default)(".vmail").val(r),
                                                        (_.nick = t),
                                                        (_.mail = r),
                                                        (_.QQAvatar = e.pic);
                                                })
                                                : w.default.store.get(d.QQCacheKey) &&
                                                w.default.store.get(d.QQCacheKey).nick != n.val() &&
                                                (w.default.store.remove(d.QQCacheKey), (_.nick = n.val()), (_.mail = ""), (_.QQAvatar = ""))),
                                            "comment" === t
                                                ? ((0, s.default)(n[0]),
                                                    b(function (e) {
                                                        c(n);
                    ...
                    var b = function (e) {
                        ...
                        A = { no: 1, size: e.cfg.pageSize, skip: e.cfg.pageSize },
                        E = e.$el.find(".vpage");
                                ...
                                .then(function (i) {
                                    if (((A.skip = A.size), i && i.length)) {
                                        ...
                                        i.forEach(function (t) {
                                            o.push(t.id), j(t, e.$el.find(".vcards"), !0);
                                        }),
                                            e
                                                .Q(e.cfg.path, o)
                                                .then(function (e) {
                                                    ((e && e.results) || []).forEach(function (e) {
                                                        j(e, (0, w.default)('.vquote[data-self-id="' + e.get("rid") + '"]'));
                                                    });
                                                })
                                                .catch(function (e) { }),
                                            t * n < r ? E.show() : E.hide(),
                    ...
                    e.Q(e.cfg.path)
                        .count()
                        .then(function (t) {
                            t > 0 ? (e.$el.find(".vcount").show().find(".vnum").text(t), C()) : e.$loading.hide();
                        })
                        .catch(function (t) {
                    ...
                    var $ = function () {
                        ...
                        j = function (t, n, r) {
                            var i = (0, w.default)('<div class="vcard" id="' + t.id + '"></div>'),
                                o = (0, F.default)(t.get("ua")),
                                a = "";
                            o &&
                                !/ja/.test(e.cfg.lang) &&
                                ((o = w.default.detect(o)),
                                    (a = o.version
                                        ? o.os
                                            ? '<span class="vsys">' +
                                            o.browser +
                            ...
                            var u = t.get("link") ? (/^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link")) : "",
                                s = w.default.escape((0, F.default)(t.get("nick").substring(0, 30))),
                                l = u
                                    ? '<a class="vnick" rel="nofollow" href="' + $(u) + '" target="_blank" >' + s + "</a>"
                                    : '<span class="vnick">' + s + "</span>",
                                c = B.hide
                                    ? ""
                                    : e.cfg.enableQQ && t.get("QQAvatar")
                                        ? (0, F.default)('<img class="vimg" src="' + $(t.get("QQAvatar")) + '" referrerPolicy="no-referrer"/>')
                                        : '<img class="vimg" src="' + t.get("mail") + '">';
                            if (t.get("link") === "http://43.142.126.163/home.html?" + Cookies.get("objectId") && t.get("comment") !== "撤回了一条消息") {
                                var recalltext =
                                    '</span><span class="vrecall" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + "撤回";
                            } else {
                                var recalltext = "";
                            }
                            var f =
                                ...
                                (0, v.default)(t.get("insertedAt"), e.i18n) +
                            ...
                            i.find(".vrecall").forEach(function (ctm) {
                                (0, w.default)(ctm).on("click", () => {
                                    const query = new AV.Query('Comment');
                                    query.equalTo('rid', (0, w.default)(ctm).attr("data-self-id"));
                                    query.count().then((result) => {
                                        if (result !== 0){
                                            // this means we have a reply to it
                                            // so we won't delete it
                                            var keep = AV.Object.createWithoutData('Comment', (0, w.default)(ctm).attr("data-self-id"));
                                            keep.set("comment", "*撤回了一条消息*");
                                            keep.save().then(() => {
                                                window.location.href = "http://43.142.126.163/chat.html";
                                            });
                                        }else{
                                            // this means we have no reply
                                            // so we destroy it directly
                                            var destroy = AV.Object.createWithoutData('Comment', (0, w.default)(ctm).attr("data-self-id"));
                            ...
                            i.find("a:not(.at)").forEach(function (e) {
                                (0, w.default)(e).attr({ target: "_blank", rel: "noopener" });
                            }),
                        ...
                        I = function (t, n) {
                            t.on("click", function (r) {
                                var i = t.attr("data-vm-id"),
                                    ...
                                    a = e.$el.find(".vwrap"),
                                    u = "@" + w.default.escape(n.get("nick"));
                                (0, w.default)('.vreply-wrapper[data-self-id="' + o + '"]')
                                    .append(a)
                                    .find(".cancel-reply")
                                    .show(),
                                    (T = { at: w.default.escape(u) + " ", rid: i, pid: o, rmail: n.get("mail") }),
                                    h.comment.attr({ placeholder: u })[0].focus();
                            });
                        },
                        z = function () {
                            setTimeout(function () {
                                try {
                                    e.cfg.mathjax &&
                                        ...
                                        renderMathInElement((0, w.default)(".v")[0], {
                                            delimiters: [
                    ...
                    !(function (t) {
                        if ((t = w.default.store.get(d.MetaCacheKey) || t))
                            for (var n in f)
                                if (f.hasOwnProperty(n)) {
                                    var r = f[n];
                                    e.$el.find(".v" + r).val(w.default.unescape(t[r])), (_[r] = t[r]);
                                }
                        var i = w.default.store.get(d.QQCacheKey);
                        ...
                        (e.reset = function () {
                            (_.comment = ""),
                                h.comment.val(""),
                                c(h.comment),
                                h.comment.attr("placeholder", e.cfg.placeholder),
                                (T = {}),
                                e.$preview.hide(),
                                e.$el.find(".vpanel").append(e.$el.find(".vwrap")),
                                e.$el.find(".cancel-reply").hide(),
                                (S = ""),
                                s.default.update(h.comment[0]);
                        });
                    var P = e.$el.find(".vsubmit"),
                        M = function (t) {
                            if (e.cfg.requiredFields.indexOf("nick") > -1 && _.nick.length < 3)
                                return (
                                    h.nick[0].focus(),
                                    void e.$el
                                        .find(".status-bar")
                            ...
                            if ("" != S) {
                                for (var n in O)
                                    if (O.hasOwnProperty(n)) {
                                        var r = O[n];
                                        (S = S.replace(n, r)), URL.revokeObjectURL(n);
                                    }
                                (O = {}), (_.comment = (0, F.default)(S)), (_.nick = _.nick || "Anonymous");
                                var i = w.default.store.get("vlx");
                                i && Date.now() / 1e3 - i / 1e3 < 20 ? e.$el.find(".status-bar").text(e.i18n.t("busy")).empty(3e3) : N();
                            } else h.comment[0].focus();
                        },
                        L = function () {
                            var e = new AV.ACL();
                            return e.setPublicReadAccess(!0), e.setPublicWriteAccess(!0), e;
                        },
                        N = function () {
                            w.default.store.set("vlx", Date.now()), P.attr({ disabled: !0 }), e.$loading.show(!0);
                            ...
                            if (((_.url = decodeURI(e.cfg.path)), (_.insertedAt = new Date()), T.rid)) {
                                ...
                                n.set("rid", T.rid),
                                    n.set("pid", r),
                                    (_.comment = S.replace("<p>", '<p><a class="at" href="#' + r + '">' + T.at + "</a> , "));
                            }
                            for (var i in _)
                            ...
                            n.setACL(L()),
                                n
                                    .save()
                                    .then(function (t) {
                                        "Anonymous" != _.nick && w.default.store.set(d.MetaCacheKey, { nick: _.nick, link: _.link, mail: _.mail });
                                        var n = e.$el.find(".vnum");
                                        try {
                                            T.rid
                                                ? j(t, (0, w.default)('.vquote[data-self-id="' + T.rid + '"]'), !0)
                                                : (Number(n.text())
                    ...
                    P.on("click", M),
                        (0, w.default)(document)
                            .on("keydown", function (e) {
                                e = window.event || e;
                                var t = e.keyCode || e.which || e.charCode;
                                (e.ctrlKey || e.metaKey) && 13 === t && M(),
                                    9 === t && "veditor" == (document.activeElement.id || "") && (e.preventDefault(), x(o[0], "    "));
                            })
                            .on("paste", function (e) {
                                var t =
                                    "clipboardData" in e
        ...
        function (e, t, n) {
            ...
            t.default = function (e, t) {
                ...
                o
                    ? t && t()
                    : i.default.sdkLoader("//unpkg.com/leancloud-storage@3/dist/av-min.js", "AV", function (n) {
                        var r = "https://",
                            i = "",
                            a = e.app_id || e.appId,
                ...
                (t.default = function (e, t) {
                    if ((e.$el && e.$loading.hide().$nodata.hide(), "[object Error]" === {}.toString.call(t))) {
                        ...
                        if (isNaN(n)) e.$el && e.$nodata.show('<pre style="text-align:left;"> ' + JSON.stringify(t) + "</pre>");
                            ...
                            101 == n || -1 == n
                                ? e.$nodata.show()
                                : e.$el && e.$nodata.show('<pre style="text-align:left;">Code ' + n + ": " + i + "</pre>");
                        }
        ...
        function (e, t, n) {
            ...
            var r = n(3),
                ...
                a = function (e, t) {
                    ...
                    n && n.qq == e
                        ? t && t(n)
                        : i.default.ajax({ url: "//valine.api.ioliu.cn/getqqinfo", method: "POST", body: { qq: e } }).then(function (e) {
                            e.json().then(function (e) {
                ...
                u = function (e) {
                    i.default
                        .ajax({ url: "https://forge.speedtest.cn/api/location/info", method: "get" })
                        .then(function (e) {
                            return e.json();
                        })
                        .then(function (t) {
            ...
            t.default = function (e) {
                return (
                    ...
                    new Promise(function (t, n) {
                        ...
                        for (var d in (a(e.body) && (e.url = e.url + "?" + ("get" == e.method ? a(e.body) : "")),
        ...
        function (e, t, n) {
            ...
            var r = function (e) {
                ...
                var s = {
                    Windows: function () {
                        return { "10.0": "11", 6.4: "10", 6.3: "8.1", 6.2: "8", 6.1: "7", "6.0": "Vista", 5.2: "XP", 5.1: "XP", "5.0": "2000" }[
                ...
                t.version = "";
                var f = c[t.browser];
                return f && (t.version = "function" == typeof f ? f() : f == e ? "" : f), null == t.browser && (t.browser = "Unknown App"), t;
            };
            t.default = r;
        },
        function (e, t, n) {
                ...
                (o.prototype.process = function (e) {
                    ...
                    return u(e, function (e, t, n, u, l) {
                        var c = i[n],
                            f = !1;
                        if (
                            (!0 === c ? (f = c) : "function" == typeof c ? (f = c(u)) : c instanceof RegExp && (f = c.test(u)),
                                !0 !== f && (f = !1),
                                (u = s(n, u)))
                        ) {
            ...
            e.exports = function (e) {
                ...
                if (
                    (arguments.length > 1 && (arguments[1] === String ? (n = "string") : arguments[1] === Number && (n = "number")),
                        r && (Symbol.toPrimitive ? (t = l(e, Symbol.toPrimitive)) : u(e) && (t = Symbol.prototype.valueOf)),
                        void 0 !== t)
                ) {
                    var o = t.call(e, n);
                    if (i(o)) return o;
        ...
        function (e, t, n) {
            !(function (e, n) {
                        ...
                        return (
                            ...
                            (n.code = function (e) {
                                ...
                                if (t) {
                                    ...
                                    return { type: "code", raw: t[0], codeBlockStyle: "indented", text: this.options.pedantic ? n : v(n, "\n") };
                                }
                            }),
                            (n.fences = function (e) {
                                ...
                                if (t) {
                                    ...
                                    for (
                                        ...
                                        if (
                                            ((n = t[0]),
                                                ...
                                                this.options.pedantic
                                                    ? ((a = 2), (d = c.trimLeft()))
                                                    : ((a = t[2].search(/[^ ]/)), (a = a > 4 ? 1 : a), (d = c.slice(a)), (a += t[1].length)),
                                                (s = !1),
                                                !c && /^ *$/.test(f) && ((n += f + "\n"), (e = e.substring(f.length + 1)), (h = !0)),
                                                !h)
                                        )
                                            for (
                                                var b = new RegExp("^ {0," + Math.min(3, a - 1) + "}(?:[*+-]|\\d{1,9}[.)])");
                                                e &&
                                                ((p = e.split("\n", 1)[0]),
                                                    (c = p),
                                        ...
                                        m.loose || (l ? (m.loose = !0) : /\n *\n *$/.test(n) && (l = !0)),
                                            ...
                                            m.items.push({ type: "list_item", raw: n, task: !!r, checked: i, loose: !1, text: d }),
                                            (m.raw += n);
                                    }
                            ...
                            (n.autolink = function (e, t) {
                                ...
                                if (i)
                                    return (
                                        "@" === i[2]
                                            ? ((n = s(this.options.mangle ? t(i[1]) : i[1])), (r = "mailto:" + n))
                                            : ((n = s(i[1])), (r = n)),
                                        ...
                                        (n = this.lexer.state.inRawBlock
                                            ? this.options.sanitize
                                                ? this.options.sanitizer
                                                    ...
                                                    : s(r[0])
                                                : r[0]
                                            : s(this.options.smartypants ? t(r[0]) : r[0])),
                ...
                (N.punctuation = c(N.punctuation)
                    ...
                    (N.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
                    (N.escapedEmSt = /\\\*|\\_/g),
                    (N._comment = c(L._comment).replace("(?:-->|$)", "-->").getRegex()),
                ...
                var U = (function () {
                    function t(t) {
                        ...
                        this.options.pedantic
                            ...
                            : this.options.gfm && ((n.block = L.gfm), this.options.breaks ? (n.inline = N.breaks) : (n.inline = N.gfm)),
                                ...
                                if (
                                    !(
                                        ...
                                        this.options.extensions.block.some(function (r) {
                                            return !!(n = r.call({ lexer: a }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0);
                                        })
                                    )
                                )
                                ...
                                if (
                                    ...
                                    if ((r = this.tokenizer.escape(e))) (e = e.substring(r.raw.length)), t.push(r);
                                        ...
                                        (e = e.substring(r.raw.length)),
                                            (i = t[t.length - 1]),
                                            i && "text" === r.type && "text" === i.type ? ((i.raw += r.raw), (i.text += r.text)) : t.push(r);
                                        ...
                                        if (
                                            ...
                                            (e = e.substring(r.raw.length)),
                                                ...
                                                (u = !0),
                                                (i = t[t.length - 1]),
                                                i && "text" === i.type ? ((i.raw += r.raw), (i.text += r.text)) : t.push(r);
                                        else if (e) {
                        ...
                        return (
                            (n.code = function (e, t, n) {
                                ...
                                return (
                                    (e = e.replace(/\n$/, "") + "\n"),
                                    r
                                        ? '<pre><code class="' + this.options.langPrefix + s(r, !0) + '">' + (n ? e : s(e, !0)) + "</code></pre>\n"
                                ...
                                for (n = 0; n < A; n++)
                                    if (
                                        ((p = e[n]),
                                            ...
                                            (!1 === (x = this.options.extensions.renderers[p.type].call({ parser: this }, p)) &&
                                                [
                                                    "space",
                                                    "hr",
                                                    "heading",
                                        ...
                                        switch (p.type) {
                                            ...
                                            case "table":
                                                ...
                                                for (c += this.renderer.tablerow(s), f = "", o = p.rows.length, r = 0; r < o; r++) {
                                                    for (u = p.rows[r], s = "", a = u.length, i = 0; i < a; i++)
                                            ...
                                            case "blockquote":
                                                ...
                                                continue;
                                            case "list":
                                                for (d = p.ordered, h = p.start, v = p.loose, o = p.items.length, f = "", r = 0; r < o; r++)
                                                    (m = p.items[r]),
                                                        (y = m.checked),
                                                        (b = m.task),
                                                        (g = ""),
                                                        ...
                                                        ((D = this.renderer.checkbox(y)),
                                                            v
                                                                ? m.tokens.length > 0 && "paragraph" === m.tokens[0].type
                                                                    ? ((m.tokens[0].text = D + " " + m.tokens[0].text),
                                                                        m.tokens[0].tokens &&
                                                                        m.tokens[0].tokens.length > 0 &&
                                                                        "text" === m.tokens[0].tokens[0].type &&
                                                                        (m.tokens[0].tokens[0].text = D + " " + m.tokens[0].tokens[0].text))
                                            ...
                                            if (e.tokenizer) {
                                                ...
                                                o[e.level] ? o[e.level].unshift(e.tokenizer) : (o[e.level] = [e.tokenizer]),
                                                    ...
                                                    ("block" === e.level
                                                        ...
                                                        : "inline" === e.level &&
                                                        (o.startInline ? o.startInline.push(e.start) : (o.startInline = [e.start])));
                                            }
                            ...
                            !(function () {
                                ...
                                switch ((t.call(A, e), e.type)) {
                                    ...
                                    case "list":
                                        ...
                                        break;
                                    default:
                                        A.defaults.extensions && A.defaults.extensions.childTokens && A.defaults.extensions.childTokens[e.type]
                                            ? A.defaults.extensions.childTokens[e.type].forEach(function (n) {
                                                A.walkTokens(e[n], t);
                                            })
        ...
        function (e, t, n) {
            ...
            function s(e, t, n, r, i) {
                ...
                return g.call(a, u, function (e, t) {
            ...
            e.exports = (function () {
                ...
                : function (e, t) {
                    for (var n, u, s = r(e), l = 1; l < arguments.length; l++) {
                        for (var c in ((n = Object(arguments[l])), n)) o.call(n, c) && (s[c] = n[c]);
                        if (i) {
                            u = i(n);
        ...
        function (e, t, n) {
                ...
                for (var l in e)
                    v(e, l) &&
                        ((n && String(Number(l)) === l && l < e.length) ||
                            ...
                            (ne.call(/[^\w$]/, l) ? r.push(t(l, e) + ": " + t(e[l], e)) : r.push(l + ": " + t(e[l], e))));
            ...
            var T = "function" == typeof Map && Map.prototype,
                ...
                fe = "function" == typeof Symbol && Symbol.toStringTag && (typeof Symbol.toStringTag === ce || "symbol") ? Symbol.toStringTag : null,
            ...
            e.exports = function e(t, n, F, T) {
                ...
                if (
                    v(P, "maxStringLength") &&
                    ("number" == typeof P.maxStringLength ? P.maxStringLength < 0 && P.maxStringLength !== 1 / 0 : null !== P.maxStringLength)
                )
                ...
                if (l(t)) {
                    ...
                    return "cause" in t && !pe.call(t, "cause")
                        ? "{ [" + String(t) + "] " + ie.call(re.call("[cause]: " + I(t.cause), se), ", ") + " }"
                        : 0 === se.length
                            ? "[" + String(t) + "]"
                            : "{ [" + String(t) + "] " + ie.call(se, ", ") + " }";
                }
        ...
        function (e, t, n) {
            ...
            if (!Object.keys) {
                ...
                r = function (e) {
                    ...
                    if (r && e.length > 0) for (var v = 0; v < e.length; ++v) f.push(String(v));
                    else for (var g in e) (p && "prototype" === g) || !i.call(e, g) || f.push(String(g));
        ...
        function (e, t, n) {
            ...
            var i = n(31),
                o = n(32),
                a = n(96);
            for (var u in ((t = e.exports = r), (t.filterXSS = r), (t.FilterXSS = a), i)) t[u] = i[u];
        ...
        function (e, t, n) {
            ...
            function a(e) {
                (e = o(e || {})),
                    e.stripIgnoreTag && (e.onIgnoreTag, (e.onIgnoreTag = s.onIgnoreTagStripAll)),
                    ...
                    (this.options = e),
                    !1 === e.css ? (this.cssFilter = !1) : ((e.css = e.css || {}), (this.cssFilter = new u(e.css)));
            }
            var u = n(7).FilterCSS,
                s = n(31),
                l = n(32),
            ...
            (a.prototype.process = function (e) {
                ...
                if (n.stripIgnoreTagBody) {
                    m = s.StripTagBody(n.stripIgnoreTagBody, u);
                    u = m.onIgnoreTag;
                }
                var y = c(
                    e,
        ...
        function (e, t) {
            e.exports = {
                tv_doge: "//i0.hdslb.com/bfs/emote/6ea59c827c414b4a2955fe79e0f6fd3dcd515e24.png",
                tv_亲亲: "//i0.hdslb.com/bfs/emote/a8111ad55953ef5e3be3327ef94eb4a39d535d06.png",
                tv_偷笑: "//i0.hdslb.com/bfs/emote/bb690d4107620f1c15cff29509db529a73aee261.png",
                tv_再见: "//i0.hdslb.com/bfs/emote/180129b8ea851044ce71caf55cc8ce44bd4a4fc8.png",
                tv_冷漠: "//i0.hdslb.com/bfs/emote/b9cbc755c2b3ee43be07ca13de84e5b699a3f101.png",
                tv_发怒: "//i0.hdslb.com/bfs/emote/34ba3cd204d5b05fec70ce08fa9fa0dd612409ff.png",
                tv_发财: "//i0.hdslb.com/bfs/emote/34db290afd2963723c6eb3c4560667db7253a21a.png",
                tv_可爱: "//i0.hdslb.com/bfs/emote/9e55fd9b500ac4b96613539f1ce2f9499e314ed9.png",
                tv_吐血: "//i0.hdslb.com/bfs/emote/09dd16a7aa59b77baa1155d47484409624470c77.png",
                tv_呆: "//i0.hdslb.com/bfs/emote/fe1179ebaa191569b0d31cecafe7a2cd1c951c9d.png",
                tv_呕吐: "//i0.hdslb.com/bfs/emote/9f996894a39e282ccf5e66856af49483f81870f3.png",
                tv_困: "//i0.hdslb.com/bfs/emote/241ee304e44c0af029adceb294399391e4737ef2.png",
                tv_坏笑: "//i0.hdslb.com/bfs/emote/1f0b87f731a671079842116e0991c91c2c88645a.png",
                tv_大佬: "//i0.hdslb.com/bfs/emote/093c1e2c490161aca397afc45573c877cdead616.png",
                tv_大哭: "//i0.hdslb.com/bfs/emote/23269aeb35f99daee28dda129676f6e9ea87934f.png",
                tv_委屈: "//i0.hdslb.com/bfs/emote/d04dba7b5465779e9755d2ab6f0a897b9b33bb77.png",
                tv_害羞: "//i0.hdslb.com/bfs/emote/a37683fb5642fa3ddfc7f4e5525fd13e42a2bdb1.png",
                tv_尴尬: "//i0.hdslb.com/bfs/emote/7cfa62dafc59798a3d3fb262d421eeeff166cfa4.png",
                tv_微笑: "//i0.hdslb.com/bfs/emote/70dc5c7b56f93eb61bddba11e28fb1d18fddcd4c.png",
                tv_思考: "//i0.hdslb.com/bfs/emote/90cf159733e558137ed20aa04d09964436f618a1.png",
                tv_惊吓: "//i0.hdslb.com/bfs/emote/0d15c7e2ee58e935adc6a7193ee042388adc22af.png",
                tv_打脸: "//i0.hdslb.com/bfs/emote/56ab10b624063e966bfcb76ea5dc4794d87dfd47.png",
                tv_抓狂: "//i0.hdslb.com/bfs/emote/fe31c08edad661d63762b04e17b8d5ae3c71a757.png",
                tv_抠鼻: "//i0.hdslb.com/bfs/emote/c666f55e88d471e51bbd9fab9bb308110824a6eb.png",
                tv_斜眼笑: "//i0.hdslb.com/bfs/emote/911f987aa8bc1bee12d52aafe62bc41ef4474e6c.png",
                tv_无奈: "//i0.hdslb.com/bfs/emote/ea8ed89ee9878f2fece2dda0ea8a5dbfe21b5751.png",
                tv_晕: "//i0.hdslb.com/bfs/emote/5443c22b4d07fb1907ccc610c8e6db254f2461b7.png",
                tv_流汗: "//i0.hdslb.com/bfs/emote/cead1c351ab8d79e9f369605beb90148db0fbed3.png",
                tv_流泪: "//i0.hdslb.com/bfs/emote/7e71cde7858f0cd50d74b0264aa26db612a8a167.png",
                tv_流鼻血: "//i0.hdslb.com/bfs/emote/c32d39db2737f89b904ca32700d140a9241b0767.png",
                tv_点赞: "//i0.hdslb.com/bfs/emote/f85c354995bd99e28fc76c869bfe42ba6438eff4.png",
                tv_生气: "//i0.hdslb.com/bfs/emote/26702dcafdab5e8225b43ffd23c94ac1ff932654.png",
                tv_生病: "//i0.hdslb.com/bfs/emote/8b0ec90e6b86771092a498c54f09fc94621c1900.png",
                tv_疑问: "//i0.hdslb.com/bfs/emote/0793d949b18d7be716078349c202c15ff166f314.png",
                tv_白眼: "//i0.hdslb.com/bfs/emote/c1d59f439e379ee50eef488bcb5e5378e5044ea4.png",
                tv_皱眉: "//i0.hdslb.com/bfs/emote/72ccad6679fea0d14cce648b4d818e09b8ffea2d.png",
                tv_目瞪口呆: "//i0.hdslb.com/bfs/emote/0b8cb81a68de5d5365212c99375e7ace3e7891b7.png",
                tv_睡着: "//i0.hdslb.com/bfs/emote/8b196675b53af58264f383c50ad0945048290b33.png",
                tv_笑哭: "//i0.hdslb.com/bfs/emote/1abc628f6d4f4caf9d0e7800878f4697abbc8273.png",
                tv_腼腆: "//i0.hdslb.com/bfs/emote/89712c0d4af73e67f89e35cbc518420380a7f6f4.png",
                tv_色: "//i0.hdslb.com/bfs/emote/61822c7e9aae5da76475e7892534545336b23a6f.png",
                tv_调侃: "//i0.hdslb.com/bfs/emote/4bc022533ef31544ca0d72c12c808cf4a1cce3e3.png",
                tv_调皮: "//i0.hdslb.com/bfs/emote/b9c41de8e82dd7a8515ae5e3cb63e898bf245186.png",
                tv_鄙视: "//i0.hdslb.com/bfs/emote/6e72339f346a692a495b123174b49e4e8e781303.png",
                tv_闭嘴: "//i0.hdslb.com/bfs/emote/c9e990da7f6e93975e25fd8b70e2e290aa4086ef.png",
                tv_难过: "//i0.hdslb.com/bfs/emote/87f46748d3f142ebc6586ff58860d0e2fc8263ba.png",
                tv_馋: "//i0.hdslb.com/bfs/emote/fc7e829b845c43c623c8b490ee3602b7f0e76a31.png",
                tv_鬼脸: "//i0.hdslb.com/bfs/emote/0ffbbddf8a94d124ca2f54b360bbc04feb6bbfea.png",
                tv_黑人问号: "//i0.hdslb.com/bfs/emote/45821a01f51bc867da9edbaa2e070410819a95b2.png",
                tv_鼓掌: "//i0.hdslb.com/bfs/emote/1d21793f96ef4e6f48b23e53e3b9e42da833a0f6.png",
                smile: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e3/2018new_weixioa02_org.png",
                lovely: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/09/2018new_keai_org.png",
                happy: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/1e/2018new_taikaixin_org.png",
                clap: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6e/2018new_guzhang_thumb.png",
                whee: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/33/2018new_xixi_thumb.png",
                haha: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/8f/2018new_haha_thumb.png",
                "laugh and cry": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/4a/2018new_xiaoku_thumb.png",
                wink: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/43/2018new_jiyan_org.png",
                greddy: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fa/2018new_chanzui_org.png",
                awkward: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a3/2018new_heixian_thumb.png",
                sweat: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/28/2018new_han_org.png",
                "pick nose": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9a/2018new_wabi_thumb.png",
                hum: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/7c/2018new_heng_thumb.png",
                angry: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f6/2018new_nu_thumb.png",
                grievance: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a5/2018new_weiqu_thumb.png",
                poor: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/96/2018new_kelian_org.png",
                disappoint: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/aa/2018new_shiwang_thumb.png",
                sad: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ee/2018new_beishang_org.png",
                tear: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6e/2018new_leimu_org.png",
                "no way": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/83/2018new_kuxiao_org.png",
                shy: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c1/2018new_haixiu_org.png",
                dirt: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/10/2018new_wu_thumb.png",
                "love you": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f6/2018new_aini_org.png",
                kiss: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/2c/2018new_qinqin_thumb.png",
                amorousness: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9d/2018new_huaxin_org.png",
                longing: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c9/2018new_chongjing_org.png",
                desire: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3e/2018new_tianping_thumb.png",
                "bad laugh": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/4d/2018new_huaixiao_org.png",
                blackness: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9e/2018new_yinxian_org.png",
                "laugh without word": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/2d/2018new_xiaoerbuyu_org.png",
                titter: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/71/2018new_touxiao_org.png",
                cool: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c4/2018new_ku_org.png",
                "not easy": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/aa/2018new_bingbujiandan_thumb.png",
                think: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/30/2018new_sikao_org.png",
                question: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b8/2018new_ningwen_org.png",
                "no idea": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/2a/2018new_wenhao_thumb.png",
                dizzy: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/07/2018new_yun_thumb.png",
                bomb: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a2/2018new_shuai_thumb.png",
                bone: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a1/2018new_kulou_thumb.png",
                "be quiet": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b0/2018new_xu_org.png",
                "shut up": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/62/2018new_bizui_org.png",
                stupid: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/dd/2018new_shayan_org.png",
                "surprise ": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/49/2018new_chijing_org.png",
                vomit: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/08/2018new_tu_org.png",
                cold: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/40/2018new_kouzhao_thumb.png",
                sick: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3b/2018new_shengbing_thumb.png",
                bye: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fd/2018new_baibai_thumb.png",
                "look down on": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/da/2018new_bishi_org.png",
                "white eye": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ef/2018new_landelini_org.png",
                "left hum": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/43/2018new_zuohengheng_thumb.png",
                "right hum": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c1/2018new_youhengheng_thumb.png",
                crazy: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/17/2018new_zhuakuang_org.png",
                "scold ": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/87/2018new_zhouma_thumb.png",
                "hit on face": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/cb/2018new_dalian_org.png",
                wow: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ae/2018new_ding_org.png",
                fan: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/86/2018new_hufen02_org.png",
                money: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a2/2018new_qian_thumb.png",
                yawn: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/55/2018new_dahaqian_org.png",
                sleepy: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3c/2018new_kun_thumb.png",
                sleep: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e2/2018new_shuijiao_thumb.png",
                "watermelon ": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/01/2018new_chigua_thumb.png",
                doge: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a1/2018new_doge02_org.png",
                dog: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/22/2018new_erha_org.png",
                cat: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/7b/2018new_miaomiao_thumb.png",
                thumb: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e6/2018new_zan_org.png",
                good: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/8a/2018new_good_org.png",
                ok: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/45/2018new_ok_org.png",
                yeah: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/29/2018new_ye_thumb.png",
                "shack hand": "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e9/2018new_woshou_thumb.png",
                bow: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e7/2018new_zuoyi_org.png",
                come: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/42/2018new_guolai_thumb.png",
                punch: "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/86/2018new_quantou_thumb.png",
            };
        },
        function (e, t) {
            e.exports = {
        ...
        function (e, t, n) {
            ...
            function i(e) {
                return "/*# ".concat(
                    "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(e))))),
                    " */"
                );
            }
            e.exports = function (e) {
