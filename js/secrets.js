    ...
    query.get(Cookies.get("objectId")).then(
        (rage) => {
            ...
            if (window.local_Tangmax>=10) {
                ...
                $("#v-pills-Crown1").html(`
                <p class="mb-0 text-start">当两条路在我面前展开</p>
                <p class="mb-0 text-start">我应该何去何从？</p>
                <p class="mb-0 text-start">——题记</p>
                <br>
                <p class="mb-0 text-start">我知道，我和他们是不同的。</p>
                <p class="mb-0 text-start">我是我们家第三个孩子。我的父亲是商人，而我的母亲血脉里有稀薄的他国王室血脉。</p>
                <p class="mb-0 text-start">————当然，呵，这王室血脉只是二代的。</p>
                <p class="mb-0 text-start">我母亲不甘心。即使她在那一次被剥夺了王室身份，但是骨子里的傲气不会让她轻易融合到平民的生活中。</p>
                <p class="mb-0 text-start">正好，我的父亲正想要一个去他国的契机，而一个落魄贵族————多好的跳板？于是便成就了这个婚姻。</p>
                <p class="mb-0 text-start">我从小就被灌输贵族礼仪。我的母亲自然不会让我去寻常的幼儿园，她送我去了民办幼儿园，还请了家庭教师。</p>
                <p class="mb-0 text-start">她希望我们培养出真正的贵族风范，从而多年后能回到家族让自己收到原属于自己认可。</p>
                <p class="mb-0 text-start">认可？</p>
                <p class="mb-0 text-start">老实说，或许我以前也确实受到了什么不当人的蛊惑：什么高人一等啊，学习外国文化啦，什么的。这也导致我在小学一直架子很高。</p>
                <p class="mb-0 text-start">然而现在，我才隐约意识到，这所谓贵族，并不是什么在天堂中的人上世积德行善所导致。</p>
                <p class="mb-0 text-start">社会就是由人搭建而成的金字塔，层层都有严明的上下级关系。每一层的人都拼了命保持自己的阶级，为子嗣铺平接下来的路，同时压榨下层的油水，维护自己所谓的优越感。</p>
                <p class="mb-0 text-start">虽然金字塔亘古以来必须存在，但是上世纪刚刚让这金字塔松动，现在仿佛又要变得更紧了。</p>
                <p class="mb-0 text-start">现在看来，我觉得自己还挺可笑的。</p>
                <p class="mb-0 text-start">这优越感一直保持到那天，我要找一本关于历史的书籍，家里的图书馆也正好没有这书。我母亲便勉为其难陪我去了新华书店。</p>
                <p class="mb-0 text-start">她自从进书店起，就开始嫌弃这里的环境差， 人多，嘈杂。</p>
                <p class="mb-0 text-start">她拦住了一位年轻人，高傲的头颅微扬：“历史书籍书架在哪里？请带路。”</p>
                <p class="mb-0 text-start">那年轻人先是微愣，紧接着忽然爆发出笑声，他笑的腰都直不起来了，真的，我以前一直觉得这样是很无礼的。</p>
                <p class="mb-0 text-start">显然我的母亲对于这样的结果也是始料未及。她勉强忍住怒气，微笑着告诉了他自己的身份，末了还补了一句：“纯正的王室血统，为我带路应当是你的荣幸。”</p>
                <p class="mb-0 text-start">她在本国时，恭维都要听的无趣了，哪受过这样的羞辱？</p>
                <p class="mb-0 text-start">“就是那位被王室赶出来的公主？”那青年一听这话，反而笑得更厉害了，“夫人，我不是想取笑您，但是这里不是你们国家，你在我们国家，你就要学会平等。你们国家贵族待遇这里不适用。”</p>
                <p class="mb-0 text-start">哎，现在看来，我就懂了为什么我母亲会被驱逐出来了。真正的贵族礼仪是应当在心里，在骨子里的，而不是流于表面的。</p>
                <p class="mb-0 text-start">贵族应当与财主打好关系，从而获得支持，保持自己的地位，这点她还是懂的，但是这点应当适用于真正的贵族。落魄贵族最应当隐忍，这点她是不懂的，大约贵族学校上课时也没有教过。要不就是她上课不认真。</p>
                <p class="mb-0 text-start">而且贵族身份真的有什么用吗？能嫁个好人家就是万幸了，还要时刻防止暗杀，太张扬真的会死的更快。</p>
                <p class="mb-0 text-start">墨水不够了，少写点吧。</p>
                <p class="mb-0 text-start">她气疯了，指着那名青年，嘴里嘟哝着什么，但是总是没找到骂人的脏话，——大概这也是什么贵族学校没教过的。</p>
                <p class="mb-0 text-start">然而那名青年的同伴也拉了拉他，他便也没有再说下去。而我的母亲则是匆匆拉着我去找到书后就立刻回家了。</p>
                <p class="mb-0 text-start">“今天的事，立刻忘掉，记住了吗？”她冷冷地对我说，双眼的瞳孔紧缩————这是极度愤怒的表现。</p>
                <p class="mb-0 text-start">然而这幅原来让我很害怕的容貌也没有什么作用了——当质疑建立，那么一切威严和共识都会失去原来的作用。</p>
                <p class="mb-0 text-start">我清楚地知道，这是不对的，但是我已经心生怀疑——她说的真的是对的吗？或者说，这只是她的一厢情愿？</p>
                <p class="mb-0 text-start">事实上家里的图书馆也不是所有书都有的，因此我也不得不隔三差五往新华书店跑。第二次母亲是坚持不去了，让管家陪我去新华书店。</p>
                <p class="mb-0 text-start">然而我又见到他了——这次见到他，他是在座椅上坐着看书。今天选的书有点多，管家吩咐说他去选书，让我在这里歇息。</p>
                <p class="mb-0 text-start">出于好奇，我凑到他旁边，但是靠的又不是太近——远远望着他手中的书，识别着封面上的字——马……？我想要凑近一点看的时候，他忽然把书盖了起来。</p>
                <p class="mb-0 text-start">“啊！”我不满出声，但我立刻意识到了错误————他注意到了我，向我这里投来目光。看到呆愣在那里的我，他皱着眉头，“你是……哦！你不是上上周来这里的……小朋友？”他小心翼翼地问。</p>
                <p class="mb-0 text-start">“这次你怎么没和你妈一起来？”他抬头四处张望，“小朋友，你觉得你妈妈做得对吗？”</p>
                <p class="mb-0 text-start">我点点头，又摇摇头；我不知道她对不对，或者说，我没有资格评判她对不对。</p>
                <p class="mb-0 text-start">他好像懂了我的意思，笑了起来：“你倒精明。”于是他掏出之前合上的书，上面赫然写着《马克思，恩格斯著：资本论》：“小朋友，你认识马克思吗？”</p>
                <p class="mb-0 text-start">我这次点点头。我之前看历史百科全书的时候确实看到过这个人，也知道马克思主义，但是我问母亲时，母亲总是称其为理想主义，我也不知道为什么。这种主义倘若实施，那必定是十分具有影响力和吸引力，但是在实现过程中的难度是难以想象的。</p>
                <p class="mb-0 text-start">“他确实是一个伟大的人。当时工业革命，工厂制度确实提高了生产力，但是这样诞生了一大批底层的工人。他们受尽压迫……”他的精神明显兴奋起来，说话便滔滔不绝，“于是他们中便出现了先驱者，遵循着人类本性的指引，意图回复平等的世界秩序……”</p>
                <p class="mb-0 text-start">他的言辞虽然工整，却能感受得到，他说这些话是十分自然的。他的内容是对我而言以前是无从触碰的。现在想来，他大概是觉得我是可以教导的，可以开导的。</p>
                <p class="mb-0 text-start">于是这些概念便如流水向我脑里涌来了：无政府状态，自由主义，利己主义者，等等等等。我自然听不懂，但是他说到兴致上我也无从打断。</p>
                <p class="mb-0 text-start">管家的脚步忽然响起，我才知道我已经过去了很久——我连忙后退两步，和他摆摆手，他却一把抓住我，把一本书塞到我的手里：“你要走吗？带着这本书，这本书很有意义。拿着！不要丢了！”</p>
                <p class="mb-0 text-start">他的力气很大，我无从挣脱，然而我能感受到他没有恶意。我小心翼翼把它收到我的衣服内，然后从容走出那里，跑到管家身边，拉住他的手。</p>
                <p class="mb-0 text-start">此刻，我的心仍然怦怦直跳。这是我第一次偷偷摸摸带东西回家，到现在那种紧张、担忧、兴奋，落在纸上仍然是活的。</p>
                <p class="mb-0 text-start">《马克思与恩格斯选集》，这名字我还记忆犹新。我那天并没有读那本书，只是把它放在了枕头下。然而我的精神，却比熬夜偷偷读书更为兴奋。看那门前闪过的灯光，我以为书被发现了，连忙偷偷把它藏进我的睡衣里，等确认只是姐姐起来上厕所，我又仿佛大舒一口气，偷偷又把书放到枕头下。我一直没敢打开那本书。</p>
                <p class="mb-0 text-start">迷迷糊糊睡着后，我做了一个梦。</p>
                <p class="mb-0 text-start">我梦到我站在一条河边，那条河仿佛浅而窄，其中的水潺潺流淌；然而某些时刻，那水下偶尔闪过黑暗的涡流，强大到令人心惊。</p>
                <p class="mb-0 text-start">只是看一眼，我仿佛就要被漩涡吸附；当我已经半只脚踏入旋涡中时，我陡然惊醒，看向窗外。依然是漆黑的夜。</p>
                <p class="mb-0 text-start">今天就写这么多吧。</p>
                <p class="mb-0 text-start">天也快亮了，又能起来晒太阳了。</p>
                `); //设置内容
            } else {
